...
headersModx = {'Authorization': 'Bearer 0c05975d76602f08b91e06beb9b2190f2b2a7fa4',
...
def post2user():
	...
	if len(salesDict) > 0:
		...
		salesYes = 'Results for following sales kits have been posted to the customer account: \r\n'
