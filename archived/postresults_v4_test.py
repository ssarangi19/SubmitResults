...
def post2user():
    ...
    compProLst = ['Ixcela Pro Complete', 'Ixcela Pro Supported', 'Ixcela FX Program']  # plans for supplements
    ...
    # Plan and Kit Codes
    planCodes = {'ixcomp01': 'Ixcela Complete', 'ixkit01': 'Ixcela Assess', 'ixprocomp01': 'Ixcela Pro Complete',
                 'ixprodir01': 'Ixcela Pro Directed', 'ixprosup01': 'Ixcela Pro Supported',
                 'ixprokit01': 'Ixcela Pro Assess', 'ixfxprog01': 'Ixcela FX Program',
                 'ixfxsnap01': 'Ixcela FX Snapshot'}
        ...
        if str((nstepudf[0].firstChild.data)) == 'Stop':
            ...
            if rModx.status_code != requests.codes.ok:  # did not POST successfully
                ...
                if (selplanType in compProLst) or (selplanType in compNames):
                    ...
                    # TO DO #
                    # Check MODX for updated address
